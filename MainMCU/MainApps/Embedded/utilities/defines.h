...
#define GENERAL_GPIO_TASK_PRIORITY          (tskIDLE_PRIORITY + 1)
...
#define COMPUTER_UNPACK_TASK_PRIORITY       (tskIDLE_PRIORITY + 2)
#define AIOBOARD_UNPACK_TASK_PRIORITY       (tskIDLE_PRIORITY + 3)
#define AIOBOARD_DRIVER_TASK_PRIORITY       (configMAX_PRIORITIES - 2)
#define COOP_MCU_UNPACK_TASK_PRIORITY       (configMAX_PRIORITIES - 1)
#define COMPUTER_DRIVER_TASK_PRIORITY       (configMAX_PRIORITIES - 1)
...
#define IRQPriority11Uart4          (KERNEL_INTERRUPT_PRIORITY_BASE)     //11
#define IRQPriority12Uart23         (KERNEL_INTERRUPT_PRIORITY_BASE + 1) //12
#define IRQPriority13InterADC       (KERNEL_INTERRUPT_PRIORITY_BASE + 2) //13
#define IRQPriority14Uart15         (KERNEL_INTERRUPT_PRIORITY_BASE + 3) //14
