...
int CPageAioTest::PktHandleWaveformComm(UartProtocolPacket *pPacket)
{
    ...
    case WF_COMM_CID_SET_QRS_1Hz1Vpp:{
        gpWaveformDev->setDISPlay("QRS_1Hz1Vpp running.");
